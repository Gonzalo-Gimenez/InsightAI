...
5. After deploy, note the API URL (e.g. `https://insightai-api.onrender.com`). Run `/health` to confirm.
...
4. Deploy. Open the site and ask: *¿Cuál es el total de ventas?* — the answer should reflect **2200** from the seeded DB.
